...
class Model {
    ...
    guardarArticulosEnStorage(articulos) {
        sessionStorage.setItem('articulos', JSON.stringify(Array.from(articulos.entries())));
    }

    guardarUsuariosEnStorage(usuarios) {
        sessionStorage.setItem('usuarios', JSON.stringify(Array.from(usuarios.entries())));
    }
