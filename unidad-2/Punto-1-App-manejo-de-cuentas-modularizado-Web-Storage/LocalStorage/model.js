...
class Model {
    ...
    cargarDatos() {
        ...
        const datosArticulos = localStorage.getItem("articulos");

        this.usuarios = datosUsuarios
            ? new Map(JSON.parse(datosUsuarios))
            : new Map([
        ...
        this.articulos = datosArticulos
            ? new Map(JSON.parse(datosArticulos))
            : new Map([
    ...
    guardarDatos() {
        localStorage.setItem("usuarios", JSON.stringify(Array.from(this.usuarios.entries())));
        localStorage.setItem("articulos", JSON.stringify(Array.from(this.articulos.entries())));
    }
